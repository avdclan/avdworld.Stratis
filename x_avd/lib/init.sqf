...
call compileFinal preprocessFile "x_avd\lib\remote.sqf";
call compileFinal preprocessFile "x_avd\lib\db.sqf";
call compileFinal preprocessFile "x_avd\lib\component.sqf";
...
call compileFinal preprocessFile "x_avd\lib\im.sqf";
